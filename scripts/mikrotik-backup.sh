...
echo -e "\n\n   Starting$BLU $CCR2004 & $CRS326 $RES config backup..\n\n"
...
CRS_BACKUP_FILE="${CRS326}_backup_$TIMESTAMP"
...
cat $BACKUP_DIR/$CRS_BACKUP_FILE.rsc >$HOME/Documents/networking-lab/leaf-crs326/config.rsc
