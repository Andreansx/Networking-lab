# 2025-08-04 23:34:55 by RouterOS 7.19.4
...
add address=10.1.1.1/27 interface=vlan20-bare-metal network=10.1.1.0
...
add dhcp-server=10.100.10.1 disabled=no interface=vlan40-vms-cts \
    local-address=10.1.4.1 name=vlan40-dhcp-relay
/ip dns
set servers=1.1.1.1
/ip route
