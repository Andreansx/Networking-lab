# 2025-07-17 01:22:48 by RouterOS 7.16.2
# software id = N85J-2N9M
#
# model = CRS326-24S+2Q+
# serial number = HGB09MRF1PQ
/interface bridge
add admin-mac=D4:01:C3:75:18:94 auto-mac=no comment=defconf name=bridgeLocal \
    vlan-filtering=yes
/interface ethernet
...
add bridge=bridgeLocal interface=sfp-sfpplus4 pvid=20
add bridge=bridgeLocal interface=sfp-sfpplus24
add bridge=bridgeLocal interface=sfp-sfpplus1
add bridge=bridgeLocal interface=sfp-sfpplus2
/interface bridge vlan
add bridge=bridgeLocal tagged=sfp-sfpplus1 untagged=sfp-sfpplus4 vlan-ids=20
add bridge=bridgeLocal tagged=bridgeLocal,sfp-sfpplus1 untagged=\
